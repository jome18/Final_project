...
ad 2.: 
The index.html provides all distinctive features and is like 3. and 4. embedded in layout.html. Index is loaded on visiting the page and on any refresh made except on 3. and 4.; the index.html includes 3 non-generic Javascript files (Services, getWebData, getModelData) and 1 generic graphic library, plotly; furthermore the body contains in
...
All botanical pollen names are provided in Latin; for display they are translated to english - but on hover they are re-translated to Latin, so you have the precise nomination. Please keep in mind
